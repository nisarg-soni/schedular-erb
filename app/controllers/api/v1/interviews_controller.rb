        ...
        class InterviewsController < ApplicationController
            ...
            def index
                ...
                @interviews.each do |inter|
                    list << inter.attributes.merge({"participants" => inter.users})
                end
            ...
            def update
                ...
                if !@interviewer || !@candidate
                    ...
                    if overlaps(@cur_interview,@interviewer,@candidate)
                        # redirect_to root_url, notice: 'Interview overlapping with existing interview'
                        render json: {status: 'ERROR-OVERLAP', message:'Overlap with existing interview detected.'},status: :ok
                    else
